...
3. [Services, Load Balancing, and Networking](/docs/concepts/services-networking/)
4. Service
...
Feature state:
Deprecated since Kubernetes v1.33
...
#### `type: NodePort` Services via localhost
...
Feature state:
Alpha since Kubernetes v1.37; disabled by default

More information about this feature

To use this feature, you (or a cluster administrator) will need to enable the [KubeProxyNFTablesLocalhostNodePorts](/docs/reference/command-line-tools-reference/feature-gates/#KubeProxyNFTablesLocalhostNodePorts) feature gate for all relevant components in your cluster.
...
* When using `nftables` mode, NodePort Services will be available on localhost when the
  ...
  (Setting it to just `all` will *not* enable localhost NodePort Services.) This is
...
*This is a stable feature in Kubernetes, and has been since the 1.26 release. You can no longer toggle this feature (the associated [feature gate](/docs/reference/command-line-tools-reference/feature-gates-removed/) has been removed).*
...
Feature state:
Deprecated since Kubernetes v1.36
...
about the [Service API object](/docs/reference/generated/kubernetes-api/v1.37/#service-v1-core).
...
Last modified July 07, 2026 at 6:34 PM PST: [Add tutorial for deploying a canary release (2b91a64232)](https://github.com/kubernetes/website/commit/2b91a642323ed049b339f6852f176d83fa771fd1)