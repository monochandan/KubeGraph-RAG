...
3. [Workloads](/docs/concepts/workloads/)
4. Pods
...
[ephemeral containers](/docs/concepts/workloads/pods/ephemeral-containers/ "A type of container that you can temporarily run inside a Pod.")
...
Feature state:
Beta since Kubernetes v1.37; disabled by default

More information about this feature

To use this feature, you (or a cluster administrator) will need to enable the [GenericWorkload](/docs/reference/command-line-tools-reference/feature-gates/#GenericWorkload) feature gate for all relevant components in your cluster.
...
like
[`patch`](/docs/reference/generated/kubernetes-api/v1.37/#patch-pod-v1-core), and
[`replace`](/docs/reference/generated/kubernetes-api/v1.37/#replace-pod-v1-core)
