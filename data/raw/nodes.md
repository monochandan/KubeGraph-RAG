...
3. [Cluster Architecture](/docs/concepts/architecture/)
4. Nodes
...
*This is a stable feature in Kubernetes, and has been since the 1.27 release. You can no longer toggle this feature (the associated [feature gate](/docs/reference/command-line-tools-reference/feature-gates-removed/) has been removed).*
...
* [API definition for Node](/docs/reference/generated/kubernetes-api/v1.37/#node-v1-core).
