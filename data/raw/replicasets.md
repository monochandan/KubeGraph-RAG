...
4. [Workload Management](/docs/concepts/workloads/controllers/)
5. ReplicaSet
...
Feature state:
Beta since Kubernetes v1.35; enabled by default
...
* `ReplicaSet` is a top-level resource in the Kubernetes REST API.
  Read the
  [ReplicaSet](/docs/reference/kubernetes-api/apps/replica-set-v1/)
...
Last modified May 13, 2026 at 9:32 PM PST: [update api-reference and ref shortcode callers for new URL structure (c37d572161)](https://github.com/kubernetes/website/commit/c37d57216103cd3473e82dc7b481bf5b34a1a197)